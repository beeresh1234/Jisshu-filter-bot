...
USERNAME = environ.get('USERNAME', "https://t.me/master_hp_raj") # ADMIN USERNAME
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'HP_Raj_Collection ')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001965914571'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001965914571')) # The movie you upload in it will be deleted from the bot.
...
request_channel = environ.get('REQUEST_CHANNEL', '-1001965914571') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002005820947')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+hf0frQmRGu41Yzll') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', False)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+nxvxKoPvhCQ1YTU1")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+nxvxKoPvhCQ1YTU1")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/+nxvxKoPvhCQ1YTU1")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "8eb15032be0a2c1a4617bd3ccb5ab7ec6f7728ca")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://telegra.ph/file/07f0e583519b4c687548b.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://telegra.ph/file/ab3a1d7ec1025a5e4dd7c.jpg')
